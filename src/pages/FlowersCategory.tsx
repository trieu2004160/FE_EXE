...
const FlowersCategory = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50/30 via-white to-yellow-50/30">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
              Đa dạng loại hoa với ý nghĩa riêng biệt, phù hợp với mọi dịp lễ
              quan trọng
            </p>
          </div>
      ...
      {/* Occasions Section - Cải thiện thiết kế */}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
              Mỗi dịp lễ mang trong mình ý nghĩa riêng, và hoa tươi là cách
              tuyệt vời để thể hiện điều đó.
            </p>
          </div>
